...
public class UbicacionInfo extends DialogFragment {
    ...
    public UbicacionInfo() {
    }

    public static UbicacionInfo newInstance(String title, String fullSnippet) {
        UbicacionInfo fragment = new UbicacionInfo();
        Bundle b = new Bundle();
